...
async def fetch_token_transfers(token_address: str, 
    ...
    def build_url(chain_id: str, contract_address: str, from_date: Optional[str] = None, 
                 to_date: Optional[str] = None, limit: int = 50, offset: int = 0) -> str:
